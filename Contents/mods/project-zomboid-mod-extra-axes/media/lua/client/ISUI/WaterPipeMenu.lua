...
WaterPipeMenu.doPipeMenu = function(player, context, worldobjects)
	...
	if canUsepipeItem then
		...
		local lineOption = subMenuShape:addOption(getText("ContextMenu_WaterPipe_Line_Param", getText("ContextMenu_WaterPipe_EW")) , worldobjects, WaterPipeMenu.onPlacePipe, player, pipeItem, "media/textures/Item_PipeSE1.png", "lineOption");
		----------------------------------------------
		...
		tooltip:setTexture("media/textures/Item_PipeSE1.png");		
		lineOption.toolTip = tooltip;		
		----------------------------------------
		local lineOption2 = subMenuShape:addOption(getText("ContextMenu_WaterPipe_Line_Param", getText("ContextMenu_WaterPipe_NS")) , worldobjects, WaterPipeMenu.onPlacePipe, player, pipeItem, "media/textures/Item_PipeNorth1.png", "lineOption2");
		----------------------------------------------
		local tooltip = ISBuildMenu.addToolTip();
		tooltip:setName(getText("ContextMenu_WaterPipe_Line"));
		tooltip.description = getText("ContextMenu_WaterPipe_Line");
		-- tooltip.description = tooltip.description .. " <LINE>" .. " <RGB:1,1,1>" .. "Water Pipe";
		tooltip:setTexture("media/textures/Item_PipeNorth1.png");		
		...
		local crossOption = subMenuShape:addOption(getText("ContextMenu_WaterPipe_Cross") , worldobjects, WaterPipeMenu.onPlacePipe, player, pipeItem, "media/textures/Item_PipeCross1.png", "crossOption");
		----------------------------------------------
		local tooltip = ISBuildMenu.addToolTip();
		tooltip:setName(getText("ContextMenu_WaterPipe_Cross"));
		tooltip.description = getText("ContextMenu_WaterPipe_Cross");
		-- tooltip.description = tooltip.description .. " <LINE>" .. " <RGB:1,1,1>" .. "Water Pipe";
		tooltip:setTexture("media/textures/Item_PipeCross1.png");		
		...
		local neOption = subMenuShape:addOption(getText("ContextMenu_WaterPipe_Corner_Param", getText("ContextMenu_WaterPipe_SW")) , worldobjects, WaterPipeMenu.onPlacePipe, player, pipeItem, "media/textures/Item_PipeCornerNE1.png", "neOption");
		----------------------------------------------
		local tooltip = ISBuildMenu.addToolTip();
		tooltip:setName(getText("ContextMenu_WaterPipe_Corner"));
		tooltip.description = getText("ContextMenu_WaterPipe_Corner");
		-- tooltip.description = tooltip.description .. " <LINE>" .. " <RGB:1,1,1>" .. "Water Pipe";
		tooltip:setTexture("media/textures/Item_PipeCornerNE1.png");		
		neOption.toolTip = tooltip;		
		----------------------------------------
		local nwOption = subMenuShape:addOption(getText("ContextMenu_WaterPipe_Corner_Param", getText("ContextMenu_WaterPipe_SE")) , worldobjects, WaterPipeMenu.onPlacePipe, player, pipeItem, "media/textures/Item_PipeCornerNW1.png", "nwOption");
		----------------------------------------------
		local tooltip = ISBuildMenu.addToolTip();
		tooltip:setName(getText("ContextMenu_WaterPipe_Corner"));
		tooltip.description = getText("ContextMenu_WaterPipe_Corner");
		-- tooltip.description = tooltip.description .. " <LINE>" .. " <RGB:1,1,1>" .. "Water Pipe";
		tooltip:setTexture("media/textures/Item_PipeCornerNW1.png");		
		nwOption.toolTip = tooltip;		
		----------------------------------------		
		local seOption = subMenuShape:addOption(getText("ContextMenu_WaterPipe_Corner_Param", getText("ContextMenu_WaterPipe_NW")) , worldobjects, WaterPipeMenu.onPlacePipe, player, pipeItem, "media/textures/Item_PipeCornerSE1.png", "seOption");
		----------------------------------------------
		local tooltip = ISBuildMenu.addToolTip();
		tooltip:setName(getText("ContextMenu_WaterPipe_Corner"));
		tooltip.description = getText("ContextMenu_WaterPipe_Corner");
		-- tooltip.description = tooltip.description .. " <LINE>" .. " <RGB:1,1,1>" .. "Water Pipe";
		tooltip:setTexture("media/textures/Item_PipeCornerSE1.png");		
		seOption.toolTip = tooltip;		
		----------------------------------------		
		local swOption = subMenuShape:addOption(getText("ContextMenu_WaterPipe_Corner_Param", getText("ContextMenu_WaterPipe_NE")) , worldobjects, WaterPipeMenu.onPlacePipe, player, pipeItem, "media/textures/Item_PipeCornerSW1.png", "swOption");
		----------------------------------------------
		local tooltip = ISBuildMenu.addToolTip();
		tooltip:setName(getText("ContextMenu_WaterPipe_Corner"));
		tooltip.description = getText("ContextMenu_WaterPipe_Corner");
		-- tooltip.description = tooltip.description .. " <LINE>" .. " <RGB:1,1,1>" .. "Water Pipe";
		tooltip:setTexture("media/textures/Item_PipeCornerSW1.png");		
		...
		local tnOption = subMenuShape:addOption(getText("ContextMenu_WaterPipe_T_Param", getText("ContextMenu_WaterPipe_North")) , worldobjects, WaterPipeMenu.onPlacePipe, player, pipeItem, "media/textures/Item_PipeTN1.png", "tnOption");
		----------------------------------------------
		local tooltip = ISBuildMenu.addToolTip();
		tooltip:setName(getText("ContextMenu_WaterPipe_T"));
		tooltip.description = getText("ContextMenu_WaterPipe_T");
		-- tooltip.description = tooltip.description .. " <LINE>" .. " <RGB:1,1,1>" .. "Water Pipe";
		tooltip:setTexture("media/textures/Item_PipeTN1.png");		
		tnOption.toolTip = tooltip;		
		----------------------------------------		
		local tsOption = subMenuShape:addOption(getText("ContextMenu_WaterPipe_T_Param", getText("ContextMenu_WaterPipe_South")) , worldobjects, WaterPipeMenu.onPlacePipe, player, pipeItem, "media/textures/Item_PipeTS1.png", "tsOption");
		----------------------------------------------
		local tooltip = ISBuildMenu.addToolTip();
		tooltip:setName(getText("ContextMenu_WaterPipe_T"));
		tooltip.description = getText("ContextMenu_WaterPipe_T");
		-- tooltip.description = tooltip.description .. " <LINE>" .. " <RGB:1,1,1>" .. "Water Pipe";
		tooltip:setTexture("media/textures/Item_PipeTS1.png");		
		tsOption.toolTip = tooltip;		
		----------------------------------------		
		local teOption = subMenuShape:addOption(getText("ContextMenu_WaterPipe_T_Param", getText("ContextMenu_WaterPipe_East")) , worldobjects, WaterPipeMenu.onPlacePipe, player, pipeItem, "media/textures/Item_PipeTE1.png", "teOption");
		----------------------------------------------
		local tooltip = ISBuildMenu.addToolTip();
		tooltip:setName(getText("ContextMenu_WaterPipe_T"));
		tooltip.description = getText("ContextMenu_WaterPipe_T");
		-- tooltip.description = tooltip.description .. " <LINE>" .. " <RGB:1,1,1>" .. "Water Pipe";
		tooltip:setTexture("media/textures/Item_PipeTE1.png");		
		teOption.toolTip = tooltip;		
		----------------------------------------		
		local twOption = subMenuShape:addOption(getText("ContextMenu_WaterPipe_T_Param", getText("ContextMenu_WaterPipe_West")) , worldobjects, WaterPipeMenu.onPlacePipe, player, pipeItem, "media/textures/Item_PipeTW1.png", "twOption");
		----------------------------------------------
		local tooltip = ISBuildMenu.addToolTip();
		tooltip:setName(getText("ContextMenu_WaterPipe_T"));
		tooltip.description = getText("ContextMenu_WaterPipe_T");
		-- tooltip.description = tooltip.description .. " <LINE>" .. " <RGB:1,1,1>" .. "Water Pipe";
		tooltip:setTexture("media/textures/Item_PipeTW1.png");		
