...
function WaterPipe.loadTextures()
	getTexture('WaterPipe1.png');
	getTexture('PipeCornerNE1.png');
	getTexture('PipeCornerNW1.png');
	getTexture('PipeCornerSE1.png');
	getTexture('PipeCornerSW1.png');
	getTexture('PipeCross1.png');
	getTexture('PipeNorth1.png');
	getTexture('PipeSE1.png');
	getTexture('PipeTN1.png');
	getTexture('PipeTS1.png');
	getTexture('PipeTE1.png');
	getTexture('PipeTW1.png');
end
